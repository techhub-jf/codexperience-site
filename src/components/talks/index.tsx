...
import ava102 from '@assets/palestrantes/avatar-2.png'
import ava101 from '@assets/palestrantes/avatar-1.png'


export const talkers: Talker[] = [
  { talker: ava101, id: 1, name: 'Sra.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' },
  { talker: ava102, id: 2, name: 'Sr.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' }, 
  { talker: ava101, id: 3, name: 'Sra.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' },
  { talker: ava102, id: 4, name: 'Sr.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' }, 
  { talker: ava101, id: 5, name: 'Sra.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' },
  { talker: ava102, id: 6, name: 'Sr.', link: 'https://www.linkedin.com/company/96068375/admin/dashboard/' }, 
];
  ...
  return (
    <div id='2' className='h-full w-full flex flex-col items-center bg-black pt-20 pb-8 gap-4 sm:gap-16'>
      <div className='space-y-4 flex justify-center flex-col max-w-xl lg:max-w-7xl'>
        <h3 className="text-white text-center text-2xl font-extrabold sm:text-6xl pb-6">EM BREVE, SABEREMOS QUEM SERÃO!</h3>
      </div>
      {/*<h3 className="text-white text-center px-2 text-x sm:text-6xl max-w-72 sm:max-w-xl lg:max-w-5xl">
        EM BREVE, SABEREMOS QUEM SERÃO!
